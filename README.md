...
**v1.9.3** · [Download](https://github.com/ribaudequin/epub-library-manager/releases/tag/v1.9.3) · Linux (AppImage) · Windows (Installer + Portable)
...
![Ko-fi](https://storage.ko-fi.com/cdn/logomarkLogo.png) [ko-fi.com/A0383T5](https://ko-fi.com/A0383T5)
